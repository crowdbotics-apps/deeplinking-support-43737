...
## Project Structure
    ...
    ├── deeplinking_support_43737  # Django project configurations
...
1. Clone this repo and `cd deeplinking_support_43737`
...
2. Clone this repo and `cd deeplinking_support_43737`
